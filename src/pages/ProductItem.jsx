                ...
                <div className="row">
                    ...
                    <div className="input-group align-items-center w-75">
                        ...
                        <button type="button" className="btn btn-primary d-flex align-items-center gap-2" 
                            onClick={()=>addCartItem(id,qtySelect)} disabled={isBtnLoading}>
                            加入購物車
                            {isBtnLoading && (<ReactLoading type={"spin"} color={"#000"} height={"1.5rem"} width={"1.5rem"}/>)}
                        </button>
                    </div>
                    </div>
                </div>
